                ...
                <div class="pricing-list bg-white">
                    <div class="pricing-header">
                        ...
                        <div class="pricing-price">
                            <font size="5" class="blue-600">ab <?= $site->getPriceFromProduct($odb, 'TEAMSPEAK'); ?>€
                                <small>pro Slot</small>
                            </font>
                        </div>
                    </div>
                    ...
                    <div class="pricing-footer">
                        <a class="btn btn-primary btn-outline" role="button"
                           href="<?php echo $url; ?>teamspeak/order"><i class="icon wb-arrow-right font-size-16 mr-15"
                                                                        aria-hidden="true"></i>Jetzt bestellen</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-2"></div>
            <div class="col-md-6 col-xl-3">
                <div class="pricing-list bg-white">
                    <div class="pricing-header">
                        ...
                        <div class="pricing-price">
                            <font size="5" class="blue-600">ab <?= $site->getPriceFromProduct($odb, 'VOICEBOT'); ?>€
                    ...
                    <div class="pricing-footer">
                        <a class="btn btn-primary btn-outline" role="button" href="<?php echo $url; ?>musikbot/order"><i
                                    class="icon wb-arrow-right font-size-16 mr-15" aria-hidden="true"></i>Jetzt
                            bestellen</a>
                    </div>
                </div>
            </div>
