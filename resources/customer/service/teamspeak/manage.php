    ...
    <div class="page-content container-fluid">
                ...
                <div class="col-md-6" style="margin-top: 120px;">
                    <div class="card card-shadow">
                        <div class="card-header card-header-transparent py-20 text-center">
                            ...
                            <a href="<?php echo $url; ?>teamspeak/<?php echo $server_id; ?>/renew"
        ...
        <ul class="nav-quick nav-quick-bordered row">
            <li class="nav-item col-md-4 col-4">
                <a class="nav-link"
                   href="<?php echo $url; ?>teamspeak/<?php echo $server_id; ?>" <?php if (empty($_GET['menu'])) {
            ...
            <li class="nav-item col-md-4 col-4">
                <a class="nav-link"
                   href="<?php echo $url; ?>teamspeak/<?php echo $server_id; ?>/viewer" <?php if ($_GET['menu'] == 'viewer') {
                    echo 'style="color: #1e88e5;"';
                } ?>>
            ...
            <li class="nav-item col-md-4 col-4">
                <a class="nav-link"
                   href="<?php echo $url; ?>teamspeak/<?php echo $server_id; ?>/tokens" <?php if ($_GET['menu'] == 'tokens') {
                    echo 'style="color: #1e88e5;"';
                } ?>>
                        ...
                        <table class="table mb-0">
                            ...
                            <?php if ($serverStatus == 'ONLINE') { ?>
                                <tr>
                                    ...
                                    <th><?php echo $serverInfos['teamspeak_ip']; ?>
                                        :<?php echo $serverInfos['teamspeak_port']; ?> <a
                                                href="ts3server://<?php echo $serverInfos['teamspeak_ip']; ?>:<?php echo $serverInfos['teamspeak_port']; ?>"
                                                class="btn btn-primary btn-sm">Verbinden</a></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo getClientsOnline($ts3_query, $serverStatus); ?>
                                        / <?php echo $serverInfos['slots']; ?></th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo $version['version']; ?> <?php if ($_SESSION['username'] == 'RIVEX') { ?>
                                            <small>(Build: <?php echo $version['build']; ?>)</small><?php } ?></th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <th><?php if (round($connection_info['connection_packetloss_total'], 2) == '1') {
                                            echo '0.00';
                                        } else {
                                            echo round($connection_info['connection_packetloss_total'], 2);
                                        } ?>%
                                    </th>
                                </tr>
                            ...
                            <?php } else { ?>
                                ...
                                <tr>
                                    <th class="text-left">IP</th>
                                    <th><?php echo $serverInfos['teamspeak_ip']; ?>
                                        :<?php echo $serverInfos['teamspeak_port']; ?></th>
                                </tr>
                                <tr>
                                    <th class="text-left">Laufzeit</th>
                                    <th><span id="countdown_text"> <span id="countdown">Lädt...</span></span></th>
                ...
                <div class="card card-shadow">
                    <div class="card-header card-header-transparent py-20 text-center">
                        ...
                        <form method="POST" action="">
                            <?php if ($serverStatus == 'ONLINE') { ?>
                                <center>
                                    <button type="button" disabled class="btn btn-block btn-success">
                            ...
                            <?php } elseif ($serverStatus == 'OFFLINE') { ?>
                                <center>
                                    <button type="submit" name="sendStart" class="btn btn-block btn-success"><span>Starten</span>
                                    </button>
            ...
            <div class="col-md-4">
                <div class="card card-shadow">
                    <div class="card-header card-header-transparent py-20 text-center">
                        ...
                        <center>
                            <a href="<?php echo $url; ?>teamspeak/<?php echo $server_id; ?>/renew"
                               class="btn btn-block btn-primary"><span>Verlängern</span></a>
                            <a href="<?php echo $url; ?>teamspeak/<?php echo $server_id; ?>/reconfigure"
                               class="btn btn-block btn-warning"><span>Up/Downgrade</span></a>
                        </center>
                    ...
                    <div class="card-header card-header-transparent py-20 text-center">
                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-xs-12 col-md-4">
                                    <select name="group" class="form-control">
                                        ...
                                        if ($serverStatus == 'OFFLINE') {
                                            echo '<option>Server Offline</option>';
                                        } else {
                                ...
                                <?php if ($serverStatus == 'OFFLINE') { ?>
                                    <div class="col-xs-12 col-md-4">
                                        <input type="text" disabled="disabled" name="description"
                                               placeholder="Beschreibung" class="form-control">
                                    </div>
                                    <div class="col-xs-12 col-md-4">
                                        <button type="button" class="btn btn-default" disabled="disabled">Token
                                            erstellen
                                        </button>
                                    </div>
                                <?php } else { ?>
                                    ...
                                    <div class="col-xs-12 col-md-4">
                                        <button type="submit" class="btn btn-default" name="createToken">Token
                                            erstellen
                                        </button>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <form method="post">
                                    <?php
                                    $tokens = listTokens($ts3_query, $serverStatus);
...
//                                        $user->removeMoney($odb, $price, $_SESSION['id']);
                            ...
                            <div class="card-header card-header-transparent py-20">
                                ...
                                <form method="post">
                                    ...
                                    <input name="slot_count" id="slot_count" class="form-control" type="number"
                                           value="<?= $serverInfos['slots']; ?>" min="10" max="1000">

                                    <br>

                                    <button name="reconfigure" type="submit" class="btn btn-primary btn-block">
                                        Up/Downgraden
                                    </button>
                                </form>
                    ...
                    <script type="text/javascript">
                        ...
                        function update() {
                            ...
                            var curr_price = <?= $site->getPriceFromProduct($odb, 'TEAMSPEAK'); ?> *
                            <?= $serverInfos['slots']; ?>;
                            var new_price = <?= $site->getPriceFromProduct($odb, 'TEAMSPEAK'); ?> *
                            parseInt($('#slot_count').val());
