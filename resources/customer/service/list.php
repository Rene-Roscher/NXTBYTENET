                        ...
                        <div class="pricing-list bg-white">
                            <div class="pricing-header">
                                ...
                                <div class="pricing-price">
                                    <font size="5" class="blue-600"><?php echo $row['teamspeak_ip']; ?>
                                        :<?php echo $row['teamspeak_port']; ?></font>
                                </div>
                            </div>
                            ...
                            <div class="pricing-footer">
                                <a class="btn btn-primary btn-outline" role="button"
                                   href="<?php echo $url; ?>teamspeak/<?php echo $row['id']; ?>"><i
                                            class="icon wb-arrow-right font-size-16 mr-15" aria-hidden="true"></i>Verwalten</a>
                            </div>
                        </div>
                    </div>
                <?php }
                ...
                while ($row = $SQLSelectService->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="pricing-list bg-white">
                            ...
                            <div class="pricing-footer">
                                <a class="btn btn-primary btn-outline" role="button"
                                   href="<?php echo $url; ?>musikbot/<?php echo $row['id']; ?>"><i
                                            class="icon wb-arrow-right font-size-16 mr-15" aria-hidden="true"></i>Verwalten</a>
                            </div>
                        </div>
                    </div>
