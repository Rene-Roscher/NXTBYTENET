                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post">
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box">
                                        <input type="radio" name="payment_method" value="PAYSAFECARD" id="paysafecard"
                                               checked> <label for="paysafecard"><img
                                                    src="<?php echo $picUrl; ?>payments/paysafecard.png"
                                                    style="width: auto;max-height: 50px;margin-right: 25px;margin-left: 5px;"></label>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="feature-box">
                                        <input type="radio" name="payment_method" value="PAYPAL" id="paypal"> <label
                                                for="paypal"><img src="<?php echo $picUrl; ?>payments/paypal.png"
                                                                  style="width: auto;max-height: 40px;margin-right: 25px;margin-left: 5px;"></label>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="feature-box">
                                        <input type="radio" name="payment_method" value="CREDITCARD" id="creditcard">
                                        <label for="creditcard"><img src="<?php echo $picUrl; ?>payments/creditcard.png"
                                                                     style="width: auto;max-height: 50px;margin-right: 25px;margin-left: 5px;"></label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-merge mb-3">
                                        <input type="text" class="form-control form-control-prepended" name="amount"
                                               placeholder="1.00">
                            ...
                            <center>
                                <small>
                                    <b>Hinweis:</b><br> Kein Abo. Der Betrag wird nur einmalig fällig, es entstehen
                                    keine weiteren Kosten. Keine Kündigung notwendig!
                                    Mit dieser Zahlung wird nur das Guthaben des Kundenkontos aufgeladen. Guthaben kann
                                    nicht wieder ausgezahlt werden.
                                </small>
                            </center>

                            <br>

                            <button type="submit" name="payNow" class="btn btn-primary btn-block">Guthaben aufladen
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <center>
                            Du hast aktuell <b><?php echo $user->getNormMoney($odb, $_SESSION['id']); ?>€</b> Guthaben
                            welches du versenden kannst.
                        </center>
