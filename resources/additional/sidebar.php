<div class="site-menubar site-menubar-light">
    <div class="site-menubar-body">
        ...
        <ul class="site-menu" data-plugin="menu">
            ...
            <li class="site-menu-item has-sub <?php if ($currPage == 'back_Dashboard') {
                echo 'active';
            } ?>">
            ...
            <li class="site-menu-item has-sub <?php if ($currPage == 'back_Bestellen') {
                echo 'active';
            } ?>">
            ...
            <li class="site-menu-item has-sub <?php if ($currPage == 'back_Meine Produkte') {
                echo 'active';
            } ?>">
            ...
            <li class="site-menu-item has-sub <?php if ($currPage == 'back_Guthaben') {
                echo 'active';
            } ?>">
            ...
            <li class="site-menu-item has-sub <?php if ($currPage == 'back_Buchhaltung') {
                echo 'active';
            } ?>">
            ...
            <li class="site-menu-item has-sub <?php if ($currPage == 'back_Mein Account') {
                echo 'active';
            } ?>">
            ...
            <?php if (!$role->isInTeam($odb, $_SESSION['id'])) { ?>
                <li class="site-menu-item has-sub  <?php if ($currPage == 'back_Support') {
                    echo 'active';
                } ?>">
                    <a href="<?= $url; ?>support">
